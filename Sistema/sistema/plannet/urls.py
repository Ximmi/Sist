...
urlpatterns = [
    ...
    path('editar_estadoformula/<pk>/', views.editar_estadoformula, name='editar_estadoformula'),
    path('editar_estadoformula2/<pk>/', views.editar_estadoformula2, name='editar_estadoformula2'),
    path('editar_estadoformula8/<pk>/', views.editar_estadoformula8, name='editar_estadoformula8'),
    path('editar_estadoformula10/<pk>/', views.editar_estadoformula10, name='editar_estadoformula10'),
    path('editar_estadoformula11/<pk>/', views.editar_estadoformula11, name='editar_estadoformula11'),
    path('editar_estadoformula12/<pk>/', views.editar_estadoformula12, name='editar_estadoformula12'),
